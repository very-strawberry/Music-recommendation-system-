...
# Load the dataset from local file instead of downloading from Kaggle
spotify_data = pd.read_csv('/content/sportify_tracks.csv')
...
# ===== SVD MATRICES for full 15 features =====
...
# ===== ANALYZING EFFECT OF DIFFERENT DIMENSIONALITIES =====
